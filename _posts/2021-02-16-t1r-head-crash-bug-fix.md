...
Is it a Head? Is it a bottle? No! It's a game bug. Solved by 2 bedroom coders. Part 2.
...
To apply patch and for use on a exploitable PlayStation 4 console, you'll need to dump the game as well as the 1.10 patch. modiify executable and install the fake patch back onto the console. There's plenty of resources online already, We won't be covering it here.
