...
<em>SPU Access Violation.</em>
</p>

# Research

`0x12C41A4` I found this memory address when I was searching for Field of View. What does it do you may ask?
...
Video showing float value adjusted, Spedup by 30x. [Full Video](https://youtu.be/beM6J7mVIeQ)
...
We now have fine control over the float values.

`3F 80 00 00 01 31 89 E8 01 50 E1 98` This affects Bloom Glow.
...
`asset needed for post-mlaa-3.png`
