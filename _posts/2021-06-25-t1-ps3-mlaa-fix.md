...
categories: patches
header:
  teaser: "https://drive.google.com/uc?id=1LADUXwpsSv1VDZNQQqKXWs_SO5xsoERR"
  overlay_image: "https://drive.google.com/uc?id=1LADUXwpsSv1VDZNQQqKXWs_SO5xsoERR"
  overlay_filter: 0.5
  og_image: "https://drive.google.com/uc?id=1LADUXwpsSv1VDZNQQqKXWs_SO5xsoERR"
...
{% include img1 image_path="https://drive.google.com/uc?id=1GPwUvKZkjj_DYf-PsUt3q_-mqmRcFRYQ" %}

<div align=center>
<em>Overbloom: Menu</em>
</div>

{% include img1 image_path="https://drive.google.com/uc?id=1-WcSm_4qLl8fyUw-7d6MrBz7DjTHUUF3" %}

<div align=center>
<em>Overbloom: In-Game</em>
</div>

{% include img1 image_path="https://drive.google.com/uc?id=11KiEe0w3sxe17noCM3g_01vBwlwLZDpA" %}

<div align=center>
<em>Rainbow aiming reticles</em>
</div>

{% include img1 image_path="https://drive.google.com/uc?id=1zKK1EwFn58BWGgaq6_R2HfX_-L97WYCf" %}

<div align=center>
<em>Grahpical issues; This place has seen better days.</em>
</div>

{% include img1 image_path="https://drive.google.com/uc?id=1s9U15H-310MHlYhpc5MHqd0_8c_Rwq7s" %}
...
{% include img1 image_path="https://drive.google.com/uc?id=16hHn9Tj5SXVgGLa4txRDBnSYtGQ9M7JS" %}

<div align=center>
<em>0x12C41A4: 1.00</em>
</div>

{% include img1 image_path="https://drive.google.com/uc?id=1PewxRcmWXjArU_ndn7AoFlYucjJuPZ7K" %}
...
{% include img1 image_path="https://drive.google.com/uc?id=1tG-wSKI2HmdKbk4qTa2Tm23X0Q4suKxF" %}
...
{% include img1 image_path="https://drive.google.com/uc?id=1nWp44yAElwg7eNM-uRY7uUwIp41gIOwe" %}
...
{% include img1 image_path="https://drive.google.com/uc?id=1AJcc1oVId5VCbMEylRZCiTGHRem7TfCy" %}

<div align=center>
<em>Bloom Glow 1.00 (Non PostOnSpu Path)</em>
</div>

{% include img1 image_path="https://drive.google.com/uc?id=1DMYaCcsrQhetPstIxNfiD24zQEyum5Qn" %}
...
{% include img1 image_path="https://drive.google.com/uc?id=1WQpB6Ilj9En-0ZXblelysKNMDp0C5D7S" %}

<div align=center>
<em>Bloom Values Adjusted; RPCS3 Screenshot. (Non PostOnSpu Path)</em>
</div>

{% include img1 image_path="https://drive.google.com/uc?id=1yhKPQI7rrCUnVVif0sGuDa7CVRLxeIhg" %}
...
{% include img1 image_path="https://drive.google.com/uc?id=1i_OO5N6VOU0U23b1t7jleB1MrH_kgRbJ" %}
...
{% include img1 image_path="https://drive.google.com/uc?id=17KQqT-Tr6g23uh_A-lDdBh45srOEj8s7" %}
...
{% include img1 image_path="https://drive.google.com/uc?id=1YSxY3Ifr6KY5_hcB8bG8za5tSRhV3CXN" %}
...
{% include img1 image_path="https://drive.google.com/uc?id=1rjCzlCoqvM4SD2ajtvY6J_QMSN7NamZk" %}
...
{% include img1 image_path="https://drive.google.com/uc?id=1IMBIs8IRtKARqyvxkR7XLa7jodJUFVce" %}
...
{% include img1 image_path="https://drive.google.com/uc?id=1KTizSk_cTFezPKZIlkI4zibRpeY_KMdk" %}
