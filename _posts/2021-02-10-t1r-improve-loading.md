...
{% include img1 image_path="https://storage.googleapis.com/assets-illusion0001/images/t1r-fast-load/ps4ch-uc3-1.png" %}

Setting this byte to 1 during gameplay allows for Unlocked FPS!

{% include img1 image_path="https://storage.googleapis.com/assets-illusion0001/images/t1r-fast-load/UC3-tear.png" %}
...
{% include img1 image_path="https://storage.googleapis.com/assets-illusion0001/images/t1r-fast-load/T1R-maindraw0.png" %}
...
{% include img1 image_path="https://storage.googleapis.com/assets-illusion0001/images/t1r-fast-load/ghidra-maindraw-ref.png" %}
